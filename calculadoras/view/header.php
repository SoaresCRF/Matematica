        ...
        <div class="row">
            <div class="medium-3 columns main-sidebar">
                <ul class="left" role="menu" id="top-nav">
                    ...
                    <li role="menuitem" class=""><a href="./equacao_segundo_grau.php" title="Calcular equação do segundo grau">Calcular equação do segundo grau</a><i></i></li>
                    <li role="menuitem" class=""><a href="./fatorar.php" title="Calculadora de Fatoração de Número">Fatorar Número</a><i></i></li>
